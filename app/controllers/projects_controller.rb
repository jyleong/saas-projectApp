class ProjectsController < ApplicationController
  ...
  def create
    ...
    @project.users << current_user ## current creatign project auto added to this projects table
    respond_to do |format|
      if @project.save
        format.html { redirect_to root_url, notice: 'Project was successfully created.' } ## try with root_path also
